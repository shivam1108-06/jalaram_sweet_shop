...
export default function CreateCashierForm({ onSuccess }: CreateCashierFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/auth/cashiers`, {
        method: 'POST',
        headers: {
      ...
      if (!response.ok) {
        setErrors({ general: data.detail || 'Failed to create cashier' })
        return
      }
